...
# PROJECT SPECIFIC
# This is here because HTTP requires that CBMC use an external solver called
...
def get_kissat_path(use_native_solver):
    ...
    if kissat_path is None:
        logging.error(textwrap.dedent("""\
            ...
            By default, HTTP uses the 'kissat' SAT solver to run the CBMC
